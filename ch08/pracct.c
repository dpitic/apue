/*
 * This program is used to print out selected fields from the process
 * accounting records.  The process accounting record files vary by platform:
 * Linux:           /var/log/account/pacct
 * FreeBSD & macOS: /var/account/acct
