/*
 * This is a modified version of recv_fd(), that returns the user ID of the
...
/**
 * Receive a file descriptor from a server process.  Also, any data received is
 * passed to (*userfunc)(STDERR_FILENO, buf, nbytes).  We have a 2-byte
